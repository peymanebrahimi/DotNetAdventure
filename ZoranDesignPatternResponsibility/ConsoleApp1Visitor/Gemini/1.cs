...
/*
 * فرض کنید می‌خواهیم یک سیستم ساده برای فروشگاه کتاب طراحی کنیم. در این سیستم، انواع مختلفی از کتاب (مانند رمان، کتاب فنی، کتاب کودک) وجود دارد و هر نوع کتاب ویژگی‌های خاص خود را دارد (مانند تعداد صفحه، ژانر، گروه سنی). همچنین می‌خواهیم بتوانیم عملیات مختلفی را روی این کتاب‌ها انجام دهیم، مثل محاسبه قیمت کل، چاپ اطلاعات کتاب، و اعمال تخفیف‌های مختلف.
 */
