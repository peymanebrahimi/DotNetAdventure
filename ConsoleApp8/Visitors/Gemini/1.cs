...
/*
 * در این پیاده‌سازی، هر نوع کتاب متدهای CalculatePrice و PrintInfo خود را دارد.
 * اگر بخواهیم عملیات جدیدی مانند اعمال تخفیف اضافه کنیم، باید این متدها را در همه کلاس‌های کتاب اضافه
 * و تغییر دهیم که باعث تکرار کد و کاهش انعطاف‌پذیری می‌شود.
